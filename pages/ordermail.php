...
$mail->SMTPDebug = 0;
$mail->isHTML(true);
$mail->Username = 'ghanistkumarpatel19@gnu.ac.in';	//	email ID through which mail is to be sent
$mail->Password = 'Zebronics_(.)';	//	password of email ID through which mail is to be sent
$mail->From = 'ghanistkumarpatel19@gnu.ac.in';	//	same email address as entered above
...
$mail->AddAddress('patelghanist@gmail.com');	//	email address of receiver
try {
		$mail->send();
