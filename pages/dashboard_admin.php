    ...
    <div class="main-panel" id="main-panel">
      ...
      <div class="panel-header panel-header-sm">
              ...
              <div class="content">
                ...
                $result = mysqli_fetch_array($stuCount);
        ...
        <div class="row">
          <div class="col-lg-3 col-lg-2">
              ...
              <div class="card"  onclick="location.href='students_admin.php'&nbsp;">
                 ...
                 <div class="hideD">
                  <div class="card-header">
                    ...
                    <h2 style="color: Blue; font-weight: bold;" class="card-title"><center>No of Students</center></h2>
                     <div class="card-body" >
                        
                    <h5 style="color: black;"><center >
                        
                            <!-- Display all the details of Students -->
                            <?php echo $result['COUNT(F_name)']; ?>
            ...
            <?php 
                $query2=" select COUNT(F_name) from users where Role_id = 2";
                $stuCount = mysqli_query($cnn,$query2);
                $result = mysqli_fetch_array($stuCount);
              ...
              <div class="card"  onclick="location.href='Lab-Assistant_admin.php'&nbsp;">
                 ...
                 <div class="hideD">
                  <div class="card-header">
                    ...
                    <h2 style="color: Blue; font-weight: bold;" class="card-title"><center>Assistants</center></h2>
                     <div class="card-body" >
              ...
              <div class="card"  onclick="location.href='Equipment_admin.php'&nbsp;">
                 ...
                 <div class="hideD">
                  <div class="card-header">
                    ...
                    <h2 style="color: Blue; font-weight: bold;" class="card-title"><center>Equipment</center></h2>
                     <div class="card-body" >
            ...
            <?php 
                $query1=" select COUNT(Admin_name) from order_request";
                $stuCount = mysqli_query($cnn,$query1);
                $result = mysqli_fetch_array($stuCount);
              ...
              <div class="card"  onclick="location.href='Order_admin.php'&nbsp;">
                 ...
                 <div class="hideD">
                  <div class="card-header">
                    ...
                    <h2  style="color: Blue; font-weight: bold;" class="card-title"><center>Total Order recieved </center></h2>
                     <div class="card-body" >
                        
                    <h5 style="color: black;"><center >
                        
                            <!-- Display all the details of Orders Scheduled -->
                            <?php echo $result['COUNT(Admin_name)']; ?>
